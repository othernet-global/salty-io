...
//
//
//// ComboPriceFeed.sol retrieves BTC and ETH price data from Chainlink and Uniswap V3.
//// It returns the Chainlink price if the difference with Uniswap's 5-minute TWAP is under 2%.
//// Otherwise, it uses Uniswap's 1-hour TWAP to resist price manipulation.
//
//contract PriceFeedA is IPriceFeed
//    {
//	uint256 public constant DECIMAL_FACTOR = 10 ** 10;
//
//	// If this restriction needs to be changed then a whole new ComboPriceFeed.sol should be used and PriceFeeds.setPriceFeedA() used
//	uint256 public constant MINIMUM_PERCENT_DIFF_FOR_CHAINLINK_ONLY_PRICE_TIMES_1000 = 2000;
//
...
//
//        // Less than 1% difference? Just return the Chainlink price
