...
contract TestArbitrage is Deployment
	...
	function _setupTokenForTesting( IERC20 token ) public
		...
		liquidity.depositLiquidityAndIncreaseShare( token, wbtc, 100 ether, 100 *10**8, 0, 0, 0, block.timestamp, false );
		liquidity.depositLiquidityAndIncreaseShare( token, weth, 100 ether, 100 ether, 0, 0, 0, block.timestamp, false );
		liquidity.depositLiquidityAndIncreaseShare( salt, wbtc, 100 ether, 100 *10**8, 0, 0, 0, block.timestamp, false );
...
//			console.log( i, profit );
	...
	function _setupTokenForTestingMin( IERC20 token ) public
		...
		liquidity.depositLiquidityAndIncreaseShare( token, wbtc, 100000000, 100000, 0, 0, 0, block.timestamp, false );
		liquidity.depositLiquidityAndIncreaseShare( token, weth, 100000000, 100000, 0, 0, 0, block.timestamp, false );
		liquidity.depositLiquidityAndIncreaseShare( salt, wbtc, 100000000, 100000, 0, 0, 0, block.timestamp, false );
		liquidity.depositLiquidityAndIncreaseShare( salt, weth, 100000000, 100000000, 0, 0, 0, block.timestamp, false );
		liquidity.depositLiquidityAndIncreaseShare( wbtc, weth, 100000, 100000000, 0, 0, 0, block.timestamp, false );
