...
contract SaltRewards is ISaltRewards
	...
	function performUpkeep( bytes32[] calldata poolIDs, uint256[] calldata profitsForPools ) external
		...
		uint256 stakingRewardsAmount = ( saltRewardsToDistribute * rewardsConfig.stakingRewardsPercent() ) / 100;
		uint256 liquidityRewardsAmount = saltRewardsToDistribute - stakingRewardsAmount;
